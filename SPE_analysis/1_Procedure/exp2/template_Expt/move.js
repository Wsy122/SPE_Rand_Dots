...
- 随机动点任务：
 - 运动：4*4=16个练习，24*4=96正式/3 block
  ...
  on_start: function() {
    ...
    if (userId % 2 === 0) {
      ...
      <div style="text-align: left; color: white; padding: 10px"> 
        <h3 style="text-align: center; font-size: 30px; margin: 10px;">任务一：匹配判断任务</h3>
  ...
  on_start: function() {
    ...
    if (userId % 2 === 0) {
      ...
      <div style="text-align: left; color: white; padding: 10px">  
        ...
        <p>您需要判断 <span style="font-weight: bold">散点图的运动方向与文字是否匹配</span>，<span style="color: hsl(135, 50%, 50%);">匹配</span> 按 <span style="color: hsl(135, 50%, 50%);">"F" 键</span>；<span style="color: red;">不匹配</span> 按 <span style="color: red;">"J" 键</span></p >
...
let conditions_match_selfLeft = [
  { coherence: 0.16, coherent_direction: 180, label: "我", correct_choice: "f", isMatch: "match", association: "self", difficulty:"hard"},
  { coherence: 0.16, coherent_direction: 0, label: "我", correct_choice: "j", isMatch: "mismatch", association: "other", difficulty:"hard"},
  { coherence: 0.20, coherent_direction: 180, label: "我", correct_choice: "f", isMatch: "match", association: "self", difficulty:"easy"},
  { coherence: 0.20, coherent_direction: 0, label: "我", correct_choice: "j", isMatch: "mismatch", association: "other", difficulty:"easy"},
  { coherence: 0.16, coherent_direction: 0, label: "他", correct_choice: "f", isMatch: "match", association: "other", difficulty:"hard"},
  { coherence: 0.16, coherent_direction: 180, label: "他", correct_choice: "j", isMatch: "mismatch", association: "self", difficulty:"hard"},
  { coherence: 0.20, coherent_direction: 0, label: "他", correct_choice: "f", isMatch: "match", association: "other", difficulty:"easy"},
  { coherence: 0.20, coherent_direction: 180, label: "他", correct_choice: "j", isMatch: "mismatch", association: "self", difficulty:"easy"}
];

let conditions_match_selfRight = [
  { coherence: 0.16, coherent_direction: 0, label: "我", correct_choice: "f", isMatch: "match", association: "self", difficulty:"hard"},
  { coherence: 0.16, coherent_direction: 180, label: "我", correct_choice: "j", isMatch: "mismatch", association: "other", difficulty:"hard"},
  { coherence: 0.20, coherent_direction: 0, label: "我", correct_choice: "f", isMatch: "match", association: "self", difficulty:"easy"},
  { coherence: 0.20, coherent_direction: 180, label: "我", correct_choice: "j", isMatch: "mismatch", association: "other", difficulty:"easy"},
  { coherence: 0.16, coherent_direction: 180, label: "他", correct_choice: "f", isMatch: "match", association: "other", difficulty:"hard"},
  { coherence: 0.16, coherent_direction: 0, label: "他", correct_choice: "j", isMatch: "mismatch", association: "self", difficulty:"hard"},
  { coherence: 0.20, coherent_direction: 180, label: "他", correct_choice: "f", isMatch: "match", association: "other", difficulty:"easy"},
  { coherence: 0.20, coherent_direction: 0, label: "他", correct_choice: "j", isMatch: "mismatch", association: "self", difficulty:"easy"}
];
...
var feedbackBlock_match = {
  ...
  trial_duration: 3000,
  stimulus: function() {
    var trials = jsPsych.data.get().filter({task: 'response'}).last(48) //这里的数量视具体情况而定，每个block多少个trial
    var correct_trials = trials.filter({correct: true});
    var accuracy = Math.round(correct_trials.count() / trials.count() * 100);
...
var instruction_RDK_beginning = {
  ...
  stimulus: `
    <div style="text-align: left; color: white; padding: 10px"> 
      <h3 style="text-align: center; font-size: 30px; margin: 10px">接下来是：运动方向判断任务</h3>
      <p>屏幕上会呈现一些运动的彩色圆点，</p>
      <p>其中一定比例的点 <span style="font-weight: bold">一致地向左或向右运动</span> ，其余点随机运动</p >
      <p>您需要忽略点的颜色并判断 <span style="font-weight: bold">一致的运动方向是向左还是向右</span>:</p >
      <ul>
...
let conditions_RDK_selfLeft = [
  ...
  { coherent_direction: 180, correct_choice: "ArrowLeft", coherence: 0.20, difficulty: "easy", association: "self",
    target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"]
  },
  { coherent_direction: 180, correct_choice: "ArrowLeft", coherence: 0.20, difficulty: "easy", association: "self",
    target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.16, difficulty: "hard", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.16, difficulty: "hard", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.20, difficulty: "easy", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.20, difficulty: "easy", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"]
...
let conditions_RDK_selfRight = [
  { coherent_direction: 180, correct_choice: "ArrowLeft", coherence: 0.16, difficulty: "hard", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"]
  },
  { coherent_direction: 180, correct_choice: "ArrowLeft", coherence: 0.16, difficulty: "hard", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"]
  },
  { coherent_direction: 180, correct_choice: "ArrowLeft", coherence: 0.20, difficulty: "easy", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"]
  },
  { coherent_direction: 180, correct_choice: "ArrowLeft", coherence: 0.20, difficulty: "easy", association: "other",
    target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.16, difficulty: "hard", association: "self",
    target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.16, difficulty: "hard", association: "self",
    target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.20, difficulty: "easy", association: "self",
    target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"]
  },
  { coherent_direction: 0, correct_choice: "ArrowRight", coherence: 0.20, difficulty: "easy", association: "self",
    target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"]
...
var RDK = {
  ...
  on_start: function() {
    ...
    // updateProportion(conditions_color)
    // var displayElement = jsPsych.getDisplayElement();
    // //1000毫秒后隐藏刺激
    // setTimeout(function() {
    //   var elements = displayElement.querySelectorAll("*");
...
var practice_block_motion = { 
  timeline: [practice_RDK_selfLeft, practice_RDK_selfRight]
};

// move.timeline.push(practice_block_motion);
...
var formal_RDK_selfLeft = {
  ...
  conditional_function: function(){
    if (userId % 2 === 0) {
      console.log("formal_motion_selfLeft");
      return true;
    } else {
      return false;
    }
...
var formal_RDK_selfRight = {
  ...
  conditional_function: function(){
    if (userId % 2 !== 0) {
      console.log("formal_motion_selfRight");
      return true;
    } else {
      return false;
    }
...
// move.timeline.push(formal_block_motion);
...
let conditions_color_selfLeft = [
  // 弱干扰
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 180,coherence: 0.16, association: "self",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 0,coherence: 0.16, association: "other",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"], correct_choice: "k", difficulty: "easy",
    coherent_direction: 180,coherence: 0.16, association: "self",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"], correct_choice: "k", difficulty: "easy",
    coherent_direction: 0,coherence: 0.16, association: "other",
  },
  { target_color_proportion: 0.54, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "hard",
    coherent_direction: 180,coherence: 0.16, association: "self",
  },
  { target_color_proportion: 0.54, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "hard",
    coherent_direction: 0,coherence: 0.16, association: "other",
  },
  { target_color_proportion: 0.54, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"], correct_choice: "k", difficulty: "hard",
    coherent_direction: 180,coherence: 0.16, association: "self",
  },
  { target_color_proportion: 0.54, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"], correct_choice: "k", difficulty: "hard",
    coherent_direction: 0,coherence: 0.16, association: "other",
  ...
  //强干扰
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 180,coherence: 0.20, association: "self",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 0,coherence: 0.20, association: "other",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"], correct_choice: "k", difficulty: "easy",
    coherent_direction: 180,coherence: 0.20, association: "self",
  },
...
let conditions_color_selfRight = [
  // 弱干扰
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 0,coherence: 0.16, association: "self",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 180,coherence: 0.16, association: "other",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"], correct_choice: "k", difficulty: "easy",
    coherent_direction: 0,coherence: 0.16, association: "self",
  },
  ...
  //强干扰
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 0,coherence: 0.20, association: "self",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(0, 50%, 50%)", "hsl(225, 50%, 50%)"], correct_choice: "d", difficulty: "easy",
    coherent_direction: 180,coherence: 0.20, association: "other",
  },
  { target_color_proportion: 0.59, dot_color_final: ["hsl(225, 50%, 50%)", "hsl(0, 50%, 50%)"], correct_choice: "k", difficulty: "easy",
    coherent_direction: 0,coherence: 0.20, association: "self",
  },
...
// // 对selfLeft的16个条件生成平衡拉丁方序列
// const ColorselfLeftBalancedSequence = generateBalancedLatinSquare(conditions_color_selfLeft);
// // 对selfRight同理
// const ColorselfRightBalancedSequence = generateBalancedLatinSquare(conditions_color_selfRight);
...
// move.timeline.push(practice_block_color);
...
// 根据被试编号判断是运动先还是颜色先
var RDK_motion_first = {
  timeline: [practice_block_motion, formal_block_motion,
    practice_block_color, formal_block_color
  ],
  conditional_function: function () {
    if (userId % 2 === 0) {
      console.log("motion_first");
      return true;
    } else {
      return false;
    }
...
var RDK_color_first = {
  timeline: [practice_block_color, formal_block_color, 
    practice_block_motion, formal_block_motion
  ],
  conditional_function: function () {
    if (userId % 2 !== 0) {
      console.log("color_first");
      return true;
    } else {
      return false;
    }
...
var block_RDK = {
  timeline: [RDK_color_first, RDK_motion_first]
};

move.timeline.push(block_RDK);
