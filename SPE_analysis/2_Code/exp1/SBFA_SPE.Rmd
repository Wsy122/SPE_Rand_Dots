...
```{r}
plot_bfs_association <- plot_aov(bfs_association_mr_acc, 'bfs_a_bf10', 'Association effect: motion rdk task(ACC)')
plot_bfs_association
...
```{r}
plot_bfs_association <- plot_aov(bfs_association_mr_rt, 'bfs_a_bf10', 'Association effect: motion rdk task(RT)')
plot_bfs_association
...
```{r}
bfs_association_cr_acc <- bf_aov(df_color_rdk, 'acc')
...
```{r}
plot_bfs_association <- plot_aov(bfs_association_cr_acc, 'bfs_a_bf10', 'Association effect: color rdk task(ACC)')
plot_bfs_association
...
```{r}
bfs_association_cr_rt <- bf_aov(df_color_rdk, 'rt')
...
```{r}
plot_bfs_association <- plot_aov(bfs_association_cr_rt, 'bfs_a_bf10', 'Association effect: color rdk task(RT)')
plot_bfs_association
